        ...
        <div>
          <div className="lg:min-h-[130vh] min-h-[110vh] !overflow-visible w-screen flex justify-center items-center">
            <div className="absolute top-[25%] z-40">
              <h1
                className="text-center 2xl:text-5xl md:text-3xl lg:text-4xl text-2xl text-floralWhite my-3 font-poppins text-white font-black"
              >
                <p>Reimagine a Play-and-Earn Metaverse</p>
              </h1>
              <p
                className="2xl:text-[22px] lg:text-[18px] text-base font-poppins text-white text-floralWhite text-center font-medium font-primary drop-shadow-2xl z-500 relative max-w-xs md:max-w-2xl mx-auto md:px-0 px-5 leading-snug pt-4"
              >
