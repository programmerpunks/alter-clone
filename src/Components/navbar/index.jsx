        ...
        <header className="text-black flex w-full backdrop-blur-[80px] h-24 items-center z-50 justify-between fixed" id="header">
          <div className="container max-w-full flex-wrap px-16 flex-col md:flex-row items-center flex ">
            ...
            <nav className="hidden lg:flex md:ml-auto  flex-wrap items-center text-xl font-poppins text-white">
              <a href="#header" className="mr-5 hover:border-b-4 border-red-600 ">Overview</a>
              <a href="/" className="mr-5 hover:border-b-4 border-red-600">Trailer</a>
              <a href="#team" className="mr-5 hover:border-b-4 border-red-600">Team</a>
              <a href="/" className="mr-5 hover:border-b-4 border-red-600">Whitepaper</a>
              <a href="/" className="mr-5 hover:border-b-4 border-red-600">Pitch Deck</a>
              <a href="/" className="mr-5 hover:border-b-4 border-red-600">
                Marketplace
              </a>
              <a href="/" className="mr-5 hover:border-b-4 border-red-600">Claim</a>
              <button
                type="button"
